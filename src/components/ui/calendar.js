...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn("p-3 bg-slate-800 border-slate-700 text-slate-100", className)}
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 border-slate-600 text-slate-100 hover:bg-slate-700"
        ),
        ...
        day_selected:
          "bg-blue-600 text-slate-100 hover:bg-blue-600 hover:text-slate-100 focus:bg-blue-600 focus:text-slate-100",
        ...
        day_range_middle:
          "aria-selected:bg-slate-700 aria-selected:text-slate-100",
